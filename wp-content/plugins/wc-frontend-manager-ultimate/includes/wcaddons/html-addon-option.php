...
$opt_label             = ! empty( $option['label'] ) ? $option['label'] : '';
...
<div class="wc-pao-addon-option-row">
	...
	<div class="wc-pao-addon-content-price">
		<input type="number" name="product_addon_option_price[<?php echo $loop; ?>][]" value="<?php echo esc_attr( wc_format_localized_price( $opt_price ) ); ?>" placeholder="0.00" class="wc_input_price" step="0.01" />
	</div>
