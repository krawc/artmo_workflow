...
class WCFMu_Support_Form_Controller {
	...
	public function processing() {
	  ...
	  if(isset($wcfm_support_tab_form_data['wcfm_support_query']) && !empty($wcfm_support_tab_form_data['wcfm_support_query'])) {
	  	...
	  	$support_query    = $wcfm_support_tab_form_data['wcfm_support_query'];
	  	...
	  	$wcfm_create_support    = "INSERT into {$wpdb->prefix}wcfm_support 
																(`query`, `order_id`, `item_id`, `product_id`, `author_id`, `vendor_id`, `customer_id`, `customer_name`, `customer_email`, `category`, `priority`, `status`)
																VALUES
																('{$support_query}', {$order_id}, {$support_item_id}, {$product_id}, {$author_id}, {$vendor_id}, {$customer_id}, '{$customer_name}', '{$customer_email}', '{$support_category}', '{$support_priority}', 'open')";
			...
			$message = str_replace( '{support}', $support_query, $message );
