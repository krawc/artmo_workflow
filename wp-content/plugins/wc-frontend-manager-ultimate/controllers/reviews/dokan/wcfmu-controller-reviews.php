    ...
    $vendor_id   = apply_filters( 'wcfm_current_vendor_id', get_current_user_id() );
        ...
        if ( get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) {
        	...
        	$wcfm_reviews_json_arr[$index][] =  '&ndash;';
				...
				$actions = '';
				if( $comment_status == '1' ) {
					$actions .= '<a class="wcfm-action-icon" target="_blank" href="' . $permalink . '"><span class="fa fa-eye text_tip" data-tip="' . esc_attr__( 'View Comment', 'dokan' ) . '"></span></a>';
					if ( dokan_get_option( 'seller_review_manage', 'dokan_general', 'on' ) == 'on' ) {
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="0" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-times-circle-o text_tip" data-tip="' . esc_attr__( 'Unapprove', 'dokan' ) . '"></span></a>';
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="spam" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-dot-circle-o text_tip" data-tip="' . esc_attr__( 'Spam', 'dokan' ) . '"></span></a>';
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="trash" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-trash-o text_tip" data-tip="' . esc_attr__( 'Trash', 'dokan' ) . '"></span></a>';
					}
				} elseif( $comment_status == '0' ) {
					if ( dokan_get_option( 'seller_review_manage', 'dokan_general', 'on' ) == 'on' ) {
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="1" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-check-circle-o text_tip" data-tip="' . esc_attr__( 'Approve', 'dokan' ) . '"></span></a>';
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="spam" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-dot-circle-o text_tip" data-tip="' . esc_attr__( 'Spam', 'dokan' ) . '"></span></a>';
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="trash" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-trash-o text_tip" data-tip="' . esc_attr__( 'Trash', 'dokan' ) . '"></span></a>';
					}
				} elseif( $comment_status == 'spam' ) {
					if ( dokan_get_option( 'seller_review_manage', 'dokan_general', 'on' ) == 'on' ) {
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="1" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-check-circle-o text_tip" data-tip="' . esc_attr__( 'Not Spam', 'dokan' ) . '"></span></a>';
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="delete" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-trash-o text_tip" data-tip="' . esc_attr__( 'Delete Permanently', 'dokan' ) . '"></span></a>';
					}
				} elseif( $comment_status == 'trash' ) {
					if ( dokan_get_option( 'seller_review_manage', 'dokan_general', 'on' ) == 'on' ) {
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="1" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-check-circle-o text_tip" data-tip="' . esc_attr__( 'Restore', 'dokan' ) . '"></span></a>';
						$actions .= '<a class="wcfm_review_status_update wcfm-action-icon" href="#" data-status="delete" data-reviewid="' . $comment->comment_ID . '"><span class="fa fa-trash-o text_tip" data-tip="' . esc_attr__( 'Delete Permanently', 'dokan' ) . '"></span></a>';
					}
				}
