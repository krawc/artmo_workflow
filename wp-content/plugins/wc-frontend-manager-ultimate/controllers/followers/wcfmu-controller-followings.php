	...
	public function processing() {
		...
		if(!empty($wcfm_supports_array)) {
			...
			foreach($wcfm_supports_array as $wcfm_supports_single) {
				...
				// Action
				$actions = '<a class="wcfm-action-icon" href="' . get_wcfm_support_manage_url($wcfm_supports_single->ID) . '"><span class="fa fa-reply text_tip" data-tip="' . esc_attr__( 'Reply', 'wc-frontend-manager-ultimate' ) . '"></span></a>';
				//$actions .= '<a class="wcfm_support_delete wcfm-action-icon" href="#" data-supportid="' . $wcfm_supports_single->ID . '"><span class="fa fa-trash-o text_tip" data-tip="' . esc_attr__( 'Delete', 'wc-frontend-manager-ultimate' ) . '"></span></a>';
