...
WPViews.AddonMapsEditor = function( $ ) {
	...
	*/
	...
	self.recreate_input_structure = function( input_name ) {
		...
		self.inputs_structure += '<p><p class="wcfm_title"><label for="' + self.create_random_id( "toolset-google-map-lat" ) + '" class="toolset-google-map-label js-wpt-auxiliar-label">' + toolset_google_address_i10n.latitude + '</label></p><input id="' + self.create_random_id( "toolset-google-map-lat", true ) + '" name="toolset-extended-form-' + input_name + '[latitude]" class="wcfm-text js-toolset-google-map-latlon js-toolset-google-map-lat toolset-google-map-lat" type="text" value="" /></p>';
		self.inputs_structure += '<p><p class="wcfm_title"><label for="' + self.create_random_id( "toolset-google-map-lon" ) + '" class="toolset-google-map-label js-wpt-auxiliar-label">' + toolset_google_address_i10n.longitude + '</label></p><input id="' + self.create_random_id( "toolset-google-map-lon", true ) + '" name="toolset-extended-form-' + input_name + '[longitude]" class="wcfm-text js-toolset-google-map-latlon js-toolset-google-map-lon toolset-google-map-lon" type="text" value="" /></p>';
	...
	*/
    ...
    $('#' + toolset_google_address_i10n.wcfmtoolsetmapsblockhead).click(function() {
			setTimeout(function() {
				self.init();
			}, 100 );
		});
