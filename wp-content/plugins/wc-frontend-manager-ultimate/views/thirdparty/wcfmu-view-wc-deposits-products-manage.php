...
<div class="page_collapsible products_manage_wc_deposits simple variable external grouped booking" id="wcfm_products_manage_form_wc_deposits_head"><label class="fa fa-credit-card"></label><?php _e('Deposists', 'wc-frontend-manager-ultimate'); ?><span></span></div>
