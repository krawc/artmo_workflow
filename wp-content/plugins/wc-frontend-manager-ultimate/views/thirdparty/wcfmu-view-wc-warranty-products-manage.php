...
<div class="page_collapsible products_manage_wc_warrenty simple variable external grouped booking" id="wcfm_products_manage_form_wc_warrenty_head"><label class="fa fa-exclamation-triangle"></label><?php _e('Warranty', 'wc-frontend-manager-ultimate'); ?><span></span></div>
