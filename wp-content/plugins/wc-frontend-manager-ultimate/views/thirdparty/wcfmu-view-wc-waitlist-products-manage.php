...
<div class="page_collapsible products_manage_wc_waitlist simple variable external grouped booking" id="wcfm_products_manage_form_wc_waitlist_head"><label class="fa fa-users"></label><?php _e('Waitlists', 'wc-frontend-manager-ultimate'); ?><span></span></div>
