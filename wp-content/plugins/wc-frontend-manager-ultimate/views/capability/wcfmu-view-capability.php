...
function wcfmu_capability_settings_product_advanced( $wcfm_capability_options ) {
	...
	$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_capability_settings_fields_vendor_product_insights', array(
																																																									 ...
																																																									 "manage_sales_price" => array('label' => __('Sales Price', 'wc-frontend-manager') , 'name' => 'wcfm_capability_options[manage_sales_price]','type' => 'checkboxoffon', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $manage_sales_price),
...
function wcfmu_capability_settings_miscellaneous_advanced( $wcfm_capability_options ) {
	...
	<?php
		$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_capability_settings_fields_settings_inside', array(  
																																 ...
																																 "store_address" => array('label' => __('Address', 'wc-frontend-manager-ultimate') , 'name' => 'wcfm_capability_options[store_address]', 'type' => 'checkboxoffon', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $store_address),
																									) ) );
}
?>