	...
	<div class="wcfm-collapse-content">
	  <div id="wcfm_page_load"></div>
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			<?php
			echo '<a id="add_new_support_dashboard" class="add_new_wcfm_ele_dashboard text_tip" href="'.wcfm_support_url().'" data-tip="' . __('Support Tickets', 'wc-frontend-manager-ultimate') . '"><span class="fa fa-life-ring"></span><span class="text">' . __( 'Tickets', 'wc-frontend-manager-ultimate') . '</span></a>';
			?>
				...
				<div class="wcfm-container">
					<div id="wcfm_new_reply_listing_expander" class="wcfm-content">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_support_ticket_reply_fields', array(
																																																		"support_ticket_reply" => array( 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele ' . $rich_editor, 'label_class' => 'wcfm_title' ),
