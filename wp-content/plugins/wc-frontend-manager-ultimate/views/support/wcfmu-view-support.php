...
<div class="collapse wcfm-collapse" id="wcfm_support_listing">
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			<?php
			//echo '<a class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_support_manage_url().'" data-tip="' . __('Add New Topic', 'wc-frontend-manager-ultimate') . '"><span class="fa fa-question-circle-o"></span><span class="text">' . __( 'Add New', 'wc-frontend-manager-ultimate' ) . '</span></a>';
			?>
