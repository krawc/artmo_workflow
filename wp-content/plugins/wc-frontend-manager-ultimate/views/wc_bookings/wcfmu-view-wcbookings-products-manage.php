...
<div class="page_collapsible products_manage_persons persons booking accommodation-booking" id="wcfm_products_manage_form_persons_head"><label class="fa fa-user"></label><?php _e('Persons', 'woocommerce-bookings'); ?><span></span></div>
<div class="wcfm-container persons booking accommodation-booking">
	<div id="wcfm_products_manage_form_persons_expander" class="wcfm-content">
		...
		$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_wcbokings_person_types_fields', array(
					...
					"_wc_booking_person_types" =>     array('label' => __('Person Types', 'woocommerce-bookings') , 'type' => 'multiinput', 'class' => 'wcfm-text person_types', 'label_class' => 'wcfm_title person_types', 'value' => $person_types, 'options' => array(
...
<div class="page_collapsible products_manage_resources resources booking accommodation-booking" id="wcfm_products_manage_form_resources_head"><label class="fa fa-briefcase"></label><?php _e('Resources', 'woocommerce-bookings'); ?><span></span></div>
