				...
				<table class="totals">
					<tfoot>
						...
						<?php if ( wc_tax_enabled() ) : ?>
							<tr>
								<td class="label description" style="text-align:left;"><?php _e( 'Tax', 'wc-frontend-manager-ultimate' ); ?>:</td>
						...
						<tr>
							<td class="label description" style="text-align:left;"><?php _e( 'Shipping', 'wc-frontend-manager-ultimate' ); ?>:</td>
						...
						<tr>
							<td class="label description" style="text-align:left;"><?php _e( 'Shipping Tax', 'wc-frontend-manager-ultimate' ); ?>:</td>
							<td class="total price" style="text-align:center;">
							  <?php
							  if( wcfm_is_marketplace() == 'wcfmmarketplace' ) {
						...
						<tr>
							<td class="label description" style="text-align:left;"><?php _e( 'Total', 'wc-frontend-manager-ultimate' ); ?>:</td>
							<td class="total price" style="text-align:center;">
...
if( $wcfm_vendor_invoice_signature && $wcfm_vendor_signature ) {
	...
	<table width="100%" style="width:100%;">
	  <tbody>
			<tr>
				<td><div style="width:100%;text-align: left;"><img src="<?php echo $wcfm_vendor_signature; ?>" /></div></td>
			</tr>
		</tbody>
	</table>
	<br/><br/>
