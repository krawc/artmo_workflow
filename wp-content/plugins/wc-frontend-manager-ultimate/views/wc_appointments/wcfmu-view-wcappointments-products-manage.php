...
$range_types = array(
											...
											'time:range' => '&nbsp;&nbsp;&nbsp;' . __( 'Date Range with time', 'wc-frontend-manager-ultimate' )
										);
...
<div class="page_collapsible products_manage_appointment appointment" id="wcfm_products_manage_form_appointment_options_head"><label class="fa fa-calendar"></label><?php _e('Appointable', 'wc-frontend-manager-ultimate'); ?><span></span></div>
