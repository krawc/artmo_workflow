	...
	public function processing() {
		...
		if(!empty($wcfm_shop_managers_array)) {
			foreach( $wcfm_shop_managers_array as $wcfm_shop_managers_single ) {
				...
				// Action
				$actions = '<a class="wcfm-action-icon" href="' . get_wcfm_shop_managers_manage_url( $wcfm_shop_managers_single->ID ) . '"><span class="fa fa-edit text_tip" data-tip="' . esc_attr__( 'Manage Manager', 'wc-frontend-manager-ultimate' ) . '"></span></a>';
				$actions .= '<a class="wcfm_manager_delete wcfm-action-icon" href="#" data-managerid="' . $wcfm_shop_managers_single->ID . '"><span class="fa fa-trash-o text_tip" data-tip="' . esc_attr__( 'Delete', 'wc-frontend-manager' ) . '"></span></a>';
