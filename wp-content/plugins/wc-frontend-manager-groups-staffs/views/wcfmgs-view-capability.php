...
function wcfmgs_capability_settings_miscellaneous_advanced( $wcfm_capability_options ) {
	...
	$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_settings_fields_capability_groups', array(  
																															 "manage_staffs" => array('label' => __('Manage Staffs', 'wc-frontend-manager-ultimate') , 'name' => 'wcfm_capability_options[manage_staffs]', 'type' => 'checkboxoffon', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $manage_staffs),
