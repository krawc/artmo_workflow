...
class WCFMgs_Shop_Staffs {
 	...
 	public function __construct() {
		...
		add_filter( 'wcfm_current_vendor_id', array( &$this, 'wcfm_load_staff_vendor' ) );
  ...
  function wcfmgs_ss_menus( $menus ) {
  	global $WCFM;
		...
		$menus = array_slice($menus, 0, 7, true) +
												array( 'wcfm-staffs' => array(   'label'  => __( 'Staffs', 'wc-frontend-manager-groups-staffs'),
  ...
  /**
	...
	function wcfmgs_shop_staff_availability_fields() {
		...
		?>
		<div class="page_collapsible profile_manage_shop_staff_availability" id="wcfm_profile_manage_form_shop_staff_availability_head"><label class="fa fa-clock-o"></label><?php _e( 'Availability', 'wc-frontend-manager-ultimate' ); ?><span></span></div>
