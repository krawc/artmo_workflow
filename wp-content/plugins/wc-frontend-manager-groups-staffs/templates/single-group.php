						...
						foreach ( $group_vendors as $loop_index => $vendor_id ) {
							...
							if( $marketplece == 'wcfmmarketplace' ) {
								...
								<li <?php post_class( $group_ele_class ); ?>>
									<a href="<?php echo $shop_link; ?>" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
										<img src="<?php echo $store_logo; ?>" alt="Placeholder" width="247" class="woocommerce-placeholder wp-post-image" height="300">
