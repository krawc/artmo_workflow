...
<div class="collapse wcfm-collapse" id="wcfm_appointments_listing">
  <div class="wcfm-page-headig">
		...
		<span class="wcfm-page-heading-text"><?php _e( 'Create Appointments', 'woocommerce-appointments' ); ?></span>
	...
	<div class="wcfm-collapse-content">
	  ...
	  <div class="wcfm-container wcfm-top-element-container">
			...
			if( $allow_wp_admin_view = apply_filters( 'wcfm_allow_wp_admin_view', true ) ) {
				?>
				<a target="_blank" class="wcfm_wp_admin_view text_tip" href="<?php echo admin_url('edit.php?post_type=wc_appointment&page=create_appointment'); ?>" data-tip="<?php _e( 'WP Admin View', 'wc-frontend-manager-ultimate' ); ?>"><span class="fa fa-wordpress"></span></a>
				<?php
			}
	  ...
	  <?php do_action( 'before_wcfm_appointments_manual' ); ?>
		...
		<div class="wcfm-container">
		  <div id="wwcfm_appointments_listing_expander" class="wcfm-content">
		    ...
		    require_once( $WCFMu->plugin_path . 'includes/appointments_manual/class-wcfm-appointments-manual.php' );
