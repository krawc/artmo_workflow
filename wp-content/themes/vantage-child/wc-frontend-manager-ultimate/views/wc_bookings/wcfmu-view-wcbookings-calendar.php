...
if( !current_user_can( 'manage_bookings' ) || !$wcfm_is_allow_booking_calendar ) {
	wcfm_restriction_message_show( "Bookings Calendar" );
	return;
}

$wc_bookings->delete_booking_dr_transients();
$view           = isset( $_REQUEST['view'] ) && 'day' === $_REQUEST['view'] ? 'Day' : 'Month';
?>
<div class="collapse wcfm-collapse" id="wcfm_bookings_listing">
  <div class="wcfm-page-headig">
		<span class="fa fa-calendar-o"></span>
		<span class="wcfm-page-heading-text"><?php _e( 'Bookings Calender', 'wc-frontend-manager-ultimate' ); ?></span>
	...
	<div class="wcfm-collapse-content">
	  ...
	  <div class="wcfm-container wcfm-top-element-container">
			...
			if( $allow_wp_admin_view = apply_filters( 'wcfm_allow_wp_admin_view', true ) ) {
				?>
				<a target="_blank" class="wcfm_wp_admin_view text_tip" href="<?php echo admin_url('edit.php?post_type=wc_booking&page=booking_calendar'); ?>" data-tip="<?php _e( 'WP Admin View', 'wc-frontend-manager-ultimate' ); ?>"><span class="fa fa-wordpress"></span></a>
				<?php
			}
			
			if( $wcfm_is_allow_manual_booking = apply_filters( 'wcfm_is_allow_manual_booking', true ) ) {
				echo '<a class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_create_bookings_url().'" data-tip="' . __( 'Create Booking', 'wc-frontend-manager-ultimate' ) . '"><span class="fa fa-calendar-plus-o"></span></a>';
			}
	  ...
	  <?php do_action( 'before_wcfm_bookings_calendar' ); ?>
		...
		<div class="wcfm-container">
		  <div id="wwcfm_bookings_listing_expander" class="wcfm-content">
		    ...
		    require_once( $WCFMu->plugin_path . 'includes/bookings_calendar/class-wcfm-bookings-calendar.php' );
