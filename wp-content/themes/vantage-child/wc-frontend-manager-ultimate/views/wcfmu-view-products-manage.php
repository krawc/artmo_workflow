...
if( !current_user_can( 'edit_products' ) || !$wcfm_is_allow_manage_products || !$wcfm_is_allow_add_products ) {
	return;
}
...
<?php if( apply_filters( 'wcfm_is_allow_advanced', true ) ) { ?>
	<!-- collapsible 10 -->
	<div class="page_collapsible products_manage_advanced simple variable external grouped booking" id="wcfm_products_manage_form_advanced_head"><label class="fa fa-th-large"></label><?php _e('Advanced', 'wc-frontend-manager-ultimate'); ?><span></span></div>
	<div class="wcfm-container simple variable external grouped booking">
		<div id="wcfm_products_manage_form_advanced_expander" class="wcfm-content">
			...
			$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_advanced', array(  
																																													"enable_reviews" => array('label' => __('Enable reviews', 'wc-frontend-manager-ultimate') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele simple variable external grouped booking', 'value' => 'enable', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $enable_reviews),
