...
<div class="wcfm-container auction non-variable-subscription">
	<div id="wcfm_products_manage_form_yithauction_expander" class="wcfm-content">
		...
		$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
			...
			"_auction_dates_from" => array( 'label' => __('Auction Date From', 'wc-frontend-manager-ultimate') , 'type' => 'text', 'placeholder' => 'YYYY-MM-DD hh:mm:ss', 'class' => 'wcfm-text wcfm_ele auction', 'label_class' => 'wcfm_title auction', 'value' => $_auction_dates_from ),
			"_auction_dates_to" => array( 'label' => __('Auction Date To', 'wc-frontend-manager-ultimate') , 'type' => 'text', 'placeholder' => 'YYYY-MM-DD hh:mm:ss', 'class' => 'wcfm-text wcfm_ele auction', 'label_class' => 'wcfm_title auction', 'value' => $_auction_dates_to ),
