...
class WCFM_WCAccommodation {
  ...
  function wcba_product_manage_general( $product_id, $product_type ) {
	  ...
	  <div class="page_collapsible products_manage_downloadable accommodation-booking" id="wcfm_products_manage_form_accommodation_options_head"><label class="fa fa-calendar"></label><?php _e('Accommodation', 'woocommerce-accommodation-bookings'); ?><span></span></div>
  ...
  function wcba_wcfm_products_manage_form_load_views( ) {
	 ...
	 require_once( $WCFMu->library->views_path . 'wc_bookings/wcfmu-view-wcaccommodation-products-manage.php' );
	}
  	...
  	if( isset( $_POST['controller'] ) ) {
  		...
  		switch( $controller ) {
  			case 'wcfm-products-manage':
  				require_once( $controllers_path . 'wcfmu-controller-wcaccommodation-products-manage.php' );
