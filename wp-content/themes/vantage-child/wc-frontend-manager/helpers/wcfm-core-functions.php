...
if(!function_exists('get_wcfm_customers_manage_messages')) {
	function get_wcfm_customers_manage_messages() {
		...
		$messages = array(
											'no_username' => __( 'Please insert Manager Username before submit.', 'wc-frontend-manager' ),
											'no_email' => __( 'Please insert Manager Email before submit.', 'wc-frontend-manager' ),
