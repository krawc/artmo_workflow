						...
						<?php
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("title" => array(
									'placeholder' => __('Title', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele wcfm_product_title wcfm_full_ele simple variable external grouped booking required-field overview-field', 'value' => $title,)
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("youTheArtist" => array(
									 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele simple variable external grouped booking overview-field required-field', 'value' => '1', 'dfvalue' => $youTheArtist)
							), $product_id, $product_type ) );
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("artistFirstName" => array(
									'placeholder' => __('First Name', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking overview-field required-field', 'value' => $artistFirstName)
							), $product_id, $product_type ) );

							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("artistLastName" => array(
									'placeholder' => __('Last Name', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking overview-field required-field', 'value' => $artistLastName)
							), $product_id, $product_type ) );
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("year" => array(
									'placeholder' => __('Year', 'wc-frontend-manager') , 'type' => 'number', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking required-field overview-field', 'value' => $year_produced)
							), $product_id, $product_type ) );

							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_details', array("materialMedia" => array(
									'placeholder' => __('Art Material', 'wc-frontend-manager') , 'type' => 'textarea', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking required-field overview-field', 'value' => $material_and_media)
							), $product_id, $product_type ) );
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("edition" => array(
								 'type' => 'radio', 'class' => 'wcfm-radio wcfm_ele simple variable external grouped booking overview-field required-field', 'dfvalue' => $edition, 'options' => array('This artwork is unique', 'This artwork is part of an edition'))
							), $product_id, $product_type ) );
...
<path d="M111 0L0 150" transform="translate(17.5 16.5)" stroke="#222222"/>
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("art_length" => array(
									'placeholder' => __('length (cm)', 'wc-frontend-manager') , 'type' => 'number', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking required-field size-field', 'value' => $length)
							), $product_id, $product_type ) );

							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("art_width" => array(
									'placeholder' => __('width (cm)', 'wc-frontend-manager') , 'type' => 'number', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking required-field threed size-field', 'value' => $width)
							), $product_id, $product_type ) );

							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("art_height" => array(
									'placeholder' => __('height (cm)', 'wc-frontend-manager') , 'type' => 'number', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking required-field size-field', 'value' => $height)
							), $product_id, $product_type ) );
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("framed_length" => array(
									'placeholder' => __('length (cm)', 'wc-frontend-manager') , 'type' => 'number', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking twod required-field size-field', 'value' => $framed_length)
							), $product_id, $product_type ) );

							$WCFM->wcfm_fields->wcfm_generate_form_field(
								apply_filters( 'wcfm_product_manage_fields_general', array("framed_height" => array(
									'placeholder' => __('height (cm)', 'wc-frontend-manager') , 'type' => 'number', 'class' => 'wcfm-text wcfm_ele wcfm_full_ele simple variable external grouped booking twod required-field size-field', 'value' => $framed_height)
							), $product_id, $product_type ) );
...
For example, if your paintings are representative of expressionist style, you can insert: Expressionism.') .'"></i>'.'</h4>';
							...
							echo '<h4 class="wcfm-product-manage section-header">'.__('THEME', 'woocommerce').'<i class="ion ion-ios-help"
								title="'. __('This is a section where you can specify your work\'s overall theme.
For example, if you paint urban landscapes, you can use a theme: Urban.') .'"></i>'.'</h4>';

							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'product_simple_fields_tag', array(  "theme_tag" => array('type' => 'textarea', 'class' => 'wcfm-textarea wcfm_ele simple variable external grouped booking', 'value' => $theme_tags, 'placeholder' => __('Separate Product Tags with commas', 'wc-frontend-manager'), 'desc' => __( "If you don't see your tag contact us at hello@artmo.com.", 'wc-frontend-manager' ) ) ) ) );
