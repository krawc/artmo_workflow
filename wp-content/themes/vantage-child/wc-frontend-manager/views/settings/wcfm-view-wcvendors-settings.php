									...
									if( ! WCVendors_Pro::get_option( 'shipping_management_cap' ) ) {
										...
										if ( $shipping_type == 'flat' ) { 
											...
											$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_vendors_settings_fields_shipping_national_flat', array(
																																									"national" => array('label' => __('Default National Shipping Fee', 'wcvendors-pro'), 'placeholder' => '0', 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $national, 'hints' => __('The default shipping fee within your country, this can be overridden on a per product basis.', 'wcvendors-pro') ),
											...
											$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_vendors_settings_fields_shipping_national_flat', array(
																																									"international" => array('label' => __( 'Default International Shipping Fee', 'wcvendors-pro' ), 'placeholder' => '0', 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $international, 'hints' => __( 'The default shipping fee outside your country, this can be overridden on a per product basis. ', 'wcvendors-pro' ) ),
