		...
		<div class="wcfm-container simple variable external grouped booking">
			<div id="wcfm_products_manage_form_policies_expander" class="wcfm-content">
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'product_manage_fields_policies', array(  
																																														...
																																														"wcfm_shipping_policy" => array('label' => __('Shipping Policy', 'wc-frontend-manager'), 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele simple variable external grouped booking wcfm_custom_field_editor ' . $rich_editor, 'label_class' => 'wcfm_title wcfm_full_ele', 'value' => $_wcfm_product_shipping_policy ),
																																														"wcfm_refund_policy" => array('label' => __('Refund Policy', 'wc-frontend-manager'), 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele simple variable external grouped booking wcfm_custom_field_editor ' . $rich_editor, 'label_class' => 'wcfm_title wcfm_full_ele', 'value' => $_wcfm_product_refund_policy ),
																																														"wcfm_cancellation_policy" => array('label' => __('Cancellation/Return/Exchange Policy', 'wc-frontend-manager'), 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele simple variable external grouped booking wcfm_custom_field_editor ' . $rich_editor, 'label_class' => 'wcfm_title wcfm_full_ele', 'value' => $_wcfm_product_cancellation_policy ),
																																									), $product_id ) );
				?>
			</div>
		</div>
