...
<div class="page_collapsible products_manage_wc_tabs_manager simple variable external grouped booking" id="wcfm_products_manage_form_wc_tabs_manager_head"><label class="fa fa-list-alt"></label><?php _e('Tabs Manager', 'wc-frontend-manager-ultimate'); ?><span></span></div>
