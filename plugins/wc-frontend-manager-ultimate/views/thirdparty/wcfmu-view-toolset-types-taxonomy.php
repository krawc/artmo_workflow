...
if( !empty( $field_groups )) {
	foreach( $field_groups as $field_group_index => $field_group ) {
		...
		if ( !empty( $field_definitions ) ) { 
			?>
			<div class="page_collapsible products_manage_<?php echo sanitize_title($field_group->get_display_name()); ?>" id="wcfm_products_manage_form_<?php echo sanitize_title($field_group->get_display_name()); ?>_head"><label class="fa fa-certificate"></label><?php echo $field_group->get_display_name(); ?><span></span></div>
