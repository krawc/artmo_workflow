				  	...
				  	foreach( $field_group_fields as $field_group_field ) {
				  		...
				  		switch( $field_group_field['type'] ) {
				  			case 'email':
								...
								case 'date_picker':
									$custom_attributes['date_format'] = str_replace( 'yyyy', 'yy', strtolower( wcfm_wp_date_format_to_js( $field_group_field['return_format'] ) ) );
								...
								case 'date_time_picker':
									$custom_attributes['date_format'] = 'm/d/yy'; //str_replace( 'yyyy', 'yy', strtolower( wcfm_wp_date_format_to_js( $field_group_field['return_format'] ) ) );
