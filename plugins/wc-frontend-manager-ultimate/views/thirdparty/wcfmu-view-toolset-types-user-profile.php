...
if( !empty( $field_groups )) {
    ...
    if( !$wcfm_is_allowed_toolset_field_group ) continue;
		...
		if ( !empty( $field_group['fields'] ) ) { 
			?>
			<div class="page_collapsible products_manage_<?php echo $field_group['id']; ?>" id="wcfm_products_manage_form_<?php echo $field_group['id']; ?>_head"><label class="fa fa-certificate"></label><?php echo $field_group['name']; ?><span></span></div>
