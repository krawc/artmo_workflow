...
<?php if( apply_filters( 'wcfm_is_allow_advanced', true ) ) { ?>
	<!-- collapsible 10 -->
	<div class="page_collapsible products_manage_advanced <?php echo apply_filters( 'wcfm_pm_block_class_advanced', 'simple variable external grouped booking' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_advanced', '' ); ?>" id="wcfm_products_manage_form_advanced_head"><label class="fa fa-th-large"></label><?php _e('Advanced', 'wc-frontend-manager-ultimate'); ?><span></span></div>
