...
if( !current_user_can( 'edit_products' ) || !$wcfm_is_allow_manage_products || !apply_filters( 'wcfm_is_allow_inventory', true ) || !apply_filters( 'wcfm_is_allow_stock_manager', true ) ) {
