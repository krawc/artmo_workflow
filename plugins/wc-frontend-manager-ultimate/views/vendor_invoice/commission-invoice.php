...
?>
<?php do_action( 'wcfm_pdf_invoice_before_document', $document_type, $order ); ?>
...
<?php do_action( 'wcfm_pdf_invoice_after_document_label', $document_type, $order ); ?>

<table class="order-data-addresses">
	<tr>
		<td class="address billing-address">
		  <?php if( wcfm_is_vendor() ) { ?>
		  	<?php $vendor_id = apply_filters( 'wcfm_current_vendor_id', get_current_user_id() ); ?>
		  	<div class="vendor-shop-name"><h3><?php echo $WCFM->wcfm_vendor_support->wcfm_get_vendor_store_name_by_vendor( $vendor_id ); ?></h3></div>
