...
if( wcfm_is_vendor() ) {
	...
	if( !empty( $product_ids ) ) {
		foreach( $product_ids as $product_id ) {
		  $products_array[$product_id] = get_the_title( $product_id );	
		}
	}
	if( !empty( $exclude_product_ids ) ) {
		foreach( $exclude_product_ids as $exclude_product_id ) {
		  $products_array[$exclude_product_id] = get_the_title( $exclude_product_id );	
		}
	}
}
