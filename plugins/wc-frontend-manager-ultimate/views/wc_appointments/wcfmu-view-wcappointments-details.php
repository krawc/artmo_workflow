		...
		<div class="wcfm-container">
			<div id="appointments_details_appointment_expander" class="wcfm-content">
				...
				<p class="form-field appointmented_product_quantity form-field-wide">
				  <label for="appointmented_product_quantity"><?php echo apply_filters( 'wcfm_appointments_qty_label', __( 'Quantity', 'woocommerce-appointments' ) ); ?>:</label>
				  <?php echo $appointment->get_qty(); ?>
				</p>
				  
				<?php 
				$product_staffs		= $appointment->get_staff_ids( 'edit' );
				$product_staffs	 = ! is_array( $product_staffs ) ? array( $product_staffs ) : $staff_ids;
				if( $product_staffs ) { 
				?>
					<p class="form-field appointmented_staff form-field-wide">
						<label for="appointmented_staff"><?php _e( 'Staff:', 'woocommerce-appointments' ) ?></label>
						<?php
				...
				<p class="form-field appointment_date_duration form-field-wide">
					<label for="appointment_date"><?php _e( 'All day', 'wc-frontend-manager-ultimate' ) ?>:</label>
