		...
		switch( $screen ) {
		  ...
		  case 'listing':
			  $screen_manager_options = array( 0 => __( 'Listing', 'wc-frontend-manager' ),
			  																 ...
			  																 2 => __( 'Products', 'wc-frontend-manager' ),
			  																 3 => __( 'Filled?', 'wp-job-manager' ),
			  																 4 => __( 'Views', 'wp-job-manager' ),
			  																 5 => __( 'Date Posted', 'wp-job-manager' ),
			  																 6 => __( 'Listing Expires', 'wp-job-manager' ),
			  																 7 => __( 'Actions', 'wc-frontend-manager-ultimate' ),
			  																);
		}
