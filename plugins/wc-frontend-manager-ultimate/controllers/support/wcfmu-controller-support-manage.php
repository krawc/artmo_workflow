...
class WCFMu_Support_Manage_Controller {
	...
	public function processing() {
	  ...
	  if(isset($_POST['support_ticket_reply']) && !empty($_POST['support_ticket_reply'])) {
	  	...
	  	$support_reply       = $_POST['support_ticket_reply'];
	  	...
	  	$wcfm_create_support_reply = "INSERT into {$wpdb->prefix}wcfm_support_response 
			...
			$reply_mail_body =   '<br/>' .  __( 'Hi', 'wc-frontend-manager-ultimate' ) .
													 ',<br/><br/>' . 
													 sprintf( __( 'You have received reply for your "%s" support request. Please check below for the details: ', 'wc-frontend-manager-ultimate' ), '{product_title}' ) .
													 '<br/><br/><strong><i>' . 
													 '"{support_reply}"' . 
													 '</i></strong><br/><br/>' .
	...
	public function processing() {
	  ...
	  if(isset($_POST['support_ticket_reply']) && !empty($_POST['support_ticket_reply'])) {
	  	...
	  	$wcfm_create_support_reply = "INSERT into {$wpdb->prefix}wcfm_support_response 
			...
			$reply_mail_body =   '<br/>' . __( 'Hi', 'wc-frontend-manager-ultimate' ) .
													 ',<br/><br/>' . 
													 __( 'You have received reply for your "{product_title}" support request. Please check below for the details: ', 'wc-frontend-manager-ultimate' ) .
													 '<br/><br/><strong><i>' . 
													 '"{support_reply}"' . 
													 '</i></strong><br/><br/>' .
													 __( 'Check more details here', 'wc-frontend-manager-ultimate' ) . ': <a href="{support_url}">' . __( 'Ticket', 'wc-frontend-manager-ultimate' ) . ' #{support_ticket_id}</a>' .
