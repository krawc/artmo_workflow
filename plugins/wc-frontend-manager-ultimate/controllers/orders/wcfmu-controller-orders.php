...
class WCFMu_Orders_Controller {
	...
	public function wcfmu_orders_actions( $actions, $wcfm_orders_single, $the_order ) {
  	...
  	if( apply_filters( 'wcfm_is_allow_order_delete', true ) ) {
  		$actions .= '<a class="wcfm_order_delete wcfm-action-icon" href="#" data-orderid="' . $the_order->get_id() . '"><span class="fa fa-trash text_tip" data-tip="' . esc_attr__( 'Delete', 'wc-frontend-manager-ultimate' ) . '"></span></a>';
  	}
