    ...
    $settings_tab_options = array("tab" => "{$this->tab}",
                                  ...
                                  "sections" => array(
                                                      "activation_settings_section" => array("title" =>  __('License Activation', 'wc-frontend-manager-ultimate'),
                                                                                         "fields" => array($WCFMu->license->license_api_key => array('title' => __('API License Key', 'wc-frontend-manager-ultimate'), 'type' => 'text', 'value' => $license_api_key, 'desc' => $api_key_ico),
