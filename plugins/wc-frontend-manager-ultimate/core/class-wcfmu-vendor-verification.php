  ...
  function wcfm_vendor_auth_requests() {
	...
	function wcfmu_vendor_verification_settings( $wcfm_options ) {
		...
		<div class="page_collapsible" id="wcfm_settings_form_vendor_verification_head">
			<label class="fa fa-angellist"></label>
			<?php _e('Vendor Verification', 'wc-frontend-manager-ultimate'); ?><span></span>
		</div>
		<div class="wcfm-container">
			<div id="wcfm_settings_form_vendor_verification_expander" class="wcfm-content">
			  <h2><?php _e('Vendor Verification', 'wc-frontend-manager-ultimate'); ?></h2>
	...
	function wcfmu_vendor_verification_user_setting_block( $user_id ) {
		?>
		<a href="<?php echo get_wcfm_profile_url(); ?>#wcfm_profile_manage_form_verification_head" class="page_collapsible page_collapsible_dummy"><label class="fa fa-angellist"></label><?php _e( 'Verification', 'wc-frontend-manager-ultimate' ); ?><span></span></a>
		<div class="wcfm-container">
	...
	function wcfmu_vendor_verification_user_setting_header( $user_id ) {
		echo '<a id="wcfm_verification_settings" class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_profile_url().'#wcfm_profile_manage_form_verification_head" data-tip="' . __( 'Verification', 'wc-frontend-manager-ultimate' ) . '"><span class="fa fa-angellist"></span><span class="text">' . __( 'Verification', 'wc-frontend-manager-ultimate' ) . '</span></a>';
	}
	...
	function wcfmu_vendor_verification_user_profile_fields() {
		...
		?>
		<div class="page_collapsible profile_manage_verification" id="wcfm_profile_manage_form_verification_head"><label class="fa fa-angellist"></label><?php _e( 'Verification', 'wc-frontend-manager-ultimate' ); ?><span></span></div>
		<div class="wcfm-container">
						...
						if( !empty( $identity_types ) ) {
							foreach( $identity_types as $identity_type ) {
								if( isset( $identity_type['is_active'] ) ) {
									...
									$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
																																		$identity_type['identity_id'] => array( 'label' => $identity_type['identity_name'], 'name' => 'vendor_verification[identity]['.$identity_type['identity_id'].']', 'type' => 'upload', 'mime' => 'Uploads', 'class' => 'wcfm-text', 'label_class' => 'wcfm_title', 'prwidth' => 32, 'value' => $identity_type_value ) 
																																		) );
								}
							}
						}
	...
	function wcfmu_vendor_verification_user_profile_meta_save( $user_id, $wcfm_profile_form ) {
		...
		if( isset( $wcfm_profile_form['vendor_verification'] ) && isset( $wcfm_profile_form['vendor_verification']['prompt_verify'] ) ) {
			...
			if( apply_filters( 'wcfm_is_allow_verification_email', true ) ) {
				...
				$mail_to = apply_filters( 'wcfm_verification_admin_email', get_bloginfo( 'admin_email' ) );
											...
											<tr>
												...
												<td>
												  <?php if( $identity_type_value ) { ?>
												  	<a class="wcfm-wp-fields-uploader" target="_blank" style="width: 32px; height: 32px;" href="<?php echo $identity_type_value; ?>"><span style="width: 32px; height: 32px; display: inline-block;" class="placeHolderDocs"></span></a>
												  <?php } else { ?>
												  	&ndash;
												  <?php } ?>
												</td>
	...
	function wcfmu_vendor_verification_manage( $vendor_id ) {
		...
		?>
		<!-- collapsible -->
		<div class="page_collapsible vendor_manage_verification" id="wcfm_vendor_manage_form_verification_head"><label class="fa fa-angellist"></label><?php _e( 'Verification', 'wc-frontend-manager-ultimate' ); ?><span></span></div>
		<div class="wcfm-container">
			<div id="wcfm_vendor_manage_form_verification_expander" class="wcfm-content">
			  <div class="wcfmvm_verification_details">
					...
					<div class="wcfmvm_verification_address_details">
						...
						$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_vendor_verification_profile_fields_address', array(
																																																		"vstreet_1" => array('label' => __('Street', 'wc-frontend-manager'), 'placeholder' => __('Street adress', 'wc-frontend-manager'), 'name' => 'vendor_verification[address][street_1]', 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'attributes' => array( 'readonly' => true), 'value' => $street_1 ),
																																																		"vstreet_2" => array('label' => __('Street 2', 'wc-frontend-manager'), 'placeholder' => __('Apartment, suit, unit etc. (optional)', 'wc-frontend-manager'), 'name' => 'vendor_verification[address][street_2]', 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'attributes' => array( 'readonly' => true),'value' => $street_2 ),
