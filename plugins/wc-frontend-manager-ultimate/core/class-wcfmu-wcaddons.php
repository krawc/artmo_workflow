...
class WCFMu_WCAddons {
    ...
    if( WCFMu_Dependencies::wcfm_wc_addons_active_check() || WCFMu_Dependencies::wcfm_wc_appointments_active_check() ) {
    	...
    	if( defined( 'WC_PRODUCT_ADDONS_VERSION' ) && version_compare( WC_PRODUCT_ADDONS_VERSION, '3.0.0', '>=' ) ) {
    		...
    		add_action( 'end_wcfm_products_manage', array( &$this, 'wcaddons_wcfm_products_manage_3' ), 200 );
  ...
  function wcaddons_wcfm_products_manage_3( $product_id ) {
  	global $WCFM, $WCFMu;
		...
		?>
		<div class="page_collapsible products_manage_wcaddons wcaddons" id="wcfm_products_manage_form_wcaddons_head"><label class="fa fa-diamond"></label><?php _e('Add-ons', 'wc-frontend-manager-ultimate'); ?><span></span></div>
			...
			<div id="wcfm_products_manage_form_wcaddons_expander" class="wcfm-content">
				...
				$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_product_manage_fields_wcaddons', array( 
					"_product_addons" =>     array('label' => __('Add-ons', 'wc-frontend-manager-ultimate') , 'type' => 'multiinput', 'class' => 'wcfm_ele wcaddons', 'label_class' => 'wcfm_title wcaddons', 'value' => $_product_addons, 'options' => array(
												...
												"options" =>     array('label' => __('Options', 'wc-frontend-manager-ultimate') . '<span class="fields_collapser fa fa-arrow-circle-o-down"></span>', 'type' => 'multiinput', 'class' => 'wcfm_ele wcaddons wcfm_wcaddons_fields', 'label_class' => 'wcfm_title wcaddons', 'options' => array(
