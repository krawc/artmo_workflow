...
class WCFMgs {
	...
	function init() {
		...
		register_post_type( 'wcfm_vendor_groups', array( 'public' => true, 'has_archive' => true, 'show_in_menu' => false, 'rewrite' => array( 'slug' => apply_filters( 'wcfm_groups_slug', 'vendor-groups' ) ) ) );
