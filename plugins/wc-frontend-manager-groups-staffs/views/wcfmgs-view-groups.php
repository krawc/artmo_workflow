	...
	<div class="wcfm-collapse-content">
	  ...
	  <div class="wcfm-container wcfm-top-element-container">
			...
			if( $has_new = apply_filters( 'wcfm_add_new_group_sub_menu', true ) ) {
				echo '<a class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_groups_manage_url().'" data-tip="' . __('Add New Group', 'wc-frontend-manager-groups-staffs') . '"><span class="fa fa-users"></span><span class="text">' . __( 'Add New', 'wc-frontend-manager' ) . '</span></a>';
			}
			if( apply_filters( 'wcfm_is_allow_groups_archive', true ) ) {
				echo '<a class="add_new_wcfm_ele_dashboard text_tip" target="_blank" href="'.get_post_type_archive_link( 'wcfm_vendor_groups' ).'" data-tip="' . __('Groups Directory', 'wc-frontend-manager-groups-staffs') . '"><span class="fa fa-eye"></span></a>';
			}
			?>
					...
					<thead>
						<tr>
						  <th><span class="fa fa-image text_tip" data-tip="<?php _e( 'Image', 'wc-frontend-manager' ); ?>"></span></th>
							...
							<th><?php _e( 'Vendor(s)', 'wc-frontend-manager-groups-staffs' ); ?></th>
