...
<div class="vendor_capability">
	...
	<div class="vendor_product_capability">
		...
		<?php if( WCFM_Dependencies::wcfmu_plugin_active_check() ) { ?>
			...
			$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_capability_settings_fields_vendor_product_fields', array(
																																																											 ...
																																																											 "manage_sales_price" => array('label' => __('Sales Price', 'wc-frontend-manager') , 'name' => 'wcfm_shop_manager_capability_options[manage_sales_price]','type' => 'checkboxoffon', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $manage_sales_price),
	...
	<div class="vendor_other_capability">
		...
		<?php
		$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_capability_settings_fields_shop_manager_orders', array(  "view_orders" => array('label' => __('View Orders', 'wc-frontend-manager') , 'name' => 'wcfm_shop_manager_capability_options[view_orders]','type' => 'checkboxoffon', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $view_orders),
		...
		$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_capability_settings_fields_shop_manager_groups', array(  
																																 "manage_groups" => array('label' => __('Manage Groups', 'wc-frontend-manager-ultimate') , 'name' => 'wcfm_shop_manager_capability_options[manage_groups]', 'type' => 'checkboxoffon', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $manage_groups),
																																 ...
																																 "manage_staffs" => array('label' => __('Manage Staffs', 'wc-frontend-manager-ultimate') , 'name' => 'wcfm_shop_manager_capability_options[manage_staffs]', 'type' => 'checkboxoffon', 'class' => 'wcfm-checkbox wcfm_ele', 'value' => 'yes', 'label_class' => 'wcfm_title checkbox_title', 'dfvalue' => $manage_staffs),
																									) ) );
		?>
