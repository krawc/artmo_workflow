...
// if( !$membership_id ) echo 'what the hell';
		...
		<div class="wcfm_membership_pay">
			...
			if( $is_free == 'yes' ) {
				...
				<form id="wcfm_membership_payment_form_free" class="wcfm wcfm_membership_payment_form">
					<div class="wcfm_review_pay_free"><?php _e( 'No payment required.', 'wc-multivendor-membership' ); ?></div>
					...
					?>
					<h2><?php _e('Your Payment', 'wcfmvm'); ?></h2>
					...
					?>
					<div class="wcfmvm-total-price woocommerce">
