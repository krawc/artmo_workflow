	...
	public function load_views( $end_point ) {
	  ...
	  switch( $end_point ) {
	  	...
	  	case 'wcfm-memberships':
	  		if( !wcfm_is_marketplace() ) {
					include_once( $this->views_path . 'wcfmvm-view-memberships-disable.php' );
				} else {
					include_once( $this->views_path . 'wcfmvm-view-memberships.php' );
				}
      break;
      ...
      case 'wcfm-memberships-manage':
      	if( !wcfm_is_marketplace() ) {
					...
					include_once( $this->views_path . 'wcfmvm-view-memberships-manage.php' );
				}
      break;
      ...
      case 'wcfm-memberships-settings':
      	if( !wcfm_is_marketplace() ) {
					...
					include_once( $this->views_path . 'wcfmvm-view-memberships-settings.php' );
				}
      break;
