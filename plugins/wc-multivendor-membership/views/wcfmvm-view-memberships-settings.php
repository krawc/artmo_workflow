...
$switch_admin_notication_subject = get_option( 'wcfm_membership_switch_admin_notication_subject', '{site_name}: Vendor Membership Subscription Change' );
$switch_admin_notication_content = get_option( 'wcfm_membership_switch_admin_notication_content', '' );
...
$switch_notication_subject = get_option( 'wcfm_membership_switch_notication_subject', '{site_name}: Membership Subscription Successfully Changed' );
$switch_notication_content = get_option( 'wcfm_membership_switch_notication_content', '' );
...
$next_payment_notication_subject = get_option( 'wcfm_membership_next_payment_notication_subject', '{site_name}: Membership Subscription Recurring Next Payment' );
$next_payment_notication_content = get_option( 'wcfm_membership_next_payment_notication_content', '' );
...
$reminder_notication_subject = get_option( 'wcfm_membership_reminder_notication_subject', '{site_name}: Membership Subscription Renewal Reminder' );
$reminder_notication_content = get_option( 'wcfm_membership_reminder_notication_content', '' );
...
$member_status = isset( $membership_cancel_rules['member_status'] ) ? $membership_cancel_rules['member_status'] : 'basic';
$product_status = isset( $membership_cancel_rules['product_status'] ) ? $membership_cancel_rules['product_status'] : 'same';

$cancel_notication_subject = get_option( 'wcfm_membership_cancel_notication_subject', '{site_name}: Membership Subscription Cancelled' );
$cancel_notication_content = get_option( 'wcfm_membership_cancel_notication_content', '' );
...
$member_status = isset( $membership_expire_rules['member_status'] ) ? $membership_expire_rules['member_status'] : 'disable';
$product_status = isset( $membership_expire_rules['product_status'] ) ? $membership_expire_rules['product_status'] : 'draft';

$expire_notication_subject = get_option( 'wcfm_membership_expire_notication_subject', '{site_name}: Membership Subscription Expired' );
$expire_notication_content = get_option( 'wcfm_membership_expire_notication_content', '' );
	...
	<div class="wcfm-collapse-content">
	  ...
	  <div class="wcfm-container wcfm-top-element-container">
	    <h2><?php _e('Membership General Options', 'wc-multivendor-membership' ); ?></h2>
			...
			<?php
			echo '<a class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_memberships_url().'" data-tip="' . __('Memberships', 'wc-multivendor-membership') . '"><span class="fa fa-user-plus"></span><span class="text">' . __( 'Memberships', 'wc-multivendor-membership') . '</span></a>';
			if( $has_new = apply_filters( 'wcfm_add_new_membership_sub_menu', true ) ) {
				echo '<a class="add_new_wcfm_ele_dashboard text_tip" href="'.get_wcfm_memberships_manage_url().'" data-tip="' . __('Add New Membership', 'wc-multivendor-membership') . '"><span class="fa fa-user-plus"></span></a>';
			}
			echo '<a class="add_new_wcfm_ele_dashboard text_tip" target="_blank" href="'.get_wcfm_membership_url().'" data-tip="' . __('Membership Plan Table', 'wc-multivendor-membership') . '"><span class="fa fa-eye"></span></a>';
			echo '<a class="add_new_wcfm_ele_dashboard wcfm_tutorials text_tip" target="_blank" href="https://www.youtube.com/embed/0l9RAgUpV2w" data-tip="' . __('Tutorial', 'wc-multivendor-membership') . '"><span class="fa fa-video-camera"></span></a>';
			?>
			...
			<div class="wcfm-tabWrap">
			  ...
			  <!-- collapsible -->
				<div class="page_collapsible" id="membership_settings_features_head">
					<label class="fa fa-diamond"></label>
				...
				<!-- collapsible -->
				<div class="page_collapsible" id="membership_settings_form_approval_manage_head">
					<label class="fa fa-check-circle-o"></label>
					<?php _e('Approval', 'wc-multivendor-membership'); ?>
				</div>
				<div class="wcfm-container">
					<div id="membership_settings_form_approval_manage_expander" class="wcfm-content">
					  <?php
				...
				<div class="page_collapsible" id="membership_settings_form_cancel_head">
					<label class="fa fa-user-times"></label>
