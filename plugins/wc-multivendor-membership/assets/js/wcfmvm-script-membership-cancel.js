jQuery(document).ready( function($) {
	...
	$('#wcfm_membership_cancel_open_modal').click(function( event ) {
		$('.wcfm-cancel-modal').addClass('visible');
	});

	$('.wcfm-cancel-nevermind').click(function( event ) {
		$('.wcfm-cancel-modal').removeClass('visible');
	});
