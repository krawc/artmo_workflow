...
if( isset( $wp->query_vars['wcfm-products-manage'] ) && !empty( $wp->query_vars['wcfm-products-manage'] ) ) {
	...
	if( $product_id ) {
		...
		$has_restricted_days = get_post_meta( $product_id, '_wc_booking_has_restricted_days', true );
...
<div class="page_collapsible products_manage_accommodation_availability accommodation-booking" id="wcfm_products_manage_form_accommodation_availability_head"><label class="fa fa-clock-o"></label><?php _e('Availability', 'woocommerce-accommodation-bookings'); ?><span></span></div>
...
<div class="page_collapsible products_manage_accommodation_costs accommodation-booking" id="wcfm_products_manage_form_accommodation_costs_head"><label class="fa fa-currency"><?php echo get_woocommerce_currency_symbol() ; ?></label><?php _e('Rates', 'woocommerce-accommodation-bookings'); ?><span></span></div>
<div class="wcfm-container accommodation-booking">
