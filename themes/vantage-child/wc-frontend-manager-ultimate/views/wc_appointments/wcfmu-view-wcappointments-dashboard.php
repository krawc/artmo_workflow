...
<div class="collapse wcfm-collapse" id="">
  <div class="wcfm-page-headig">
		<span class="fa fa-clock-ocalendar-check-o"></span>
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container-box">
		  <?php if( $allow_wp_admin_view = apply_filters( 'wcfm_allow_wp_admin_view', true ) ) { ?>
				<div>
					<a class="wcfm_appointment_gloabl_settings wcfm_gloabl_settings text_tip" href="<?php echo get_wcfm_appointment_settings_url(); ?>" data-tip="<?php _e( 'Global Availability', 'woocommerce-appointments' ); ?>"><span class="fa fa-cog"></span></a>
				</div>
				...
				<div class="wcfm-container">
					...
					<?php } ?>
						<div id="wcfm_appointments_product_add_expander" class="wcfm-content">
							<div class="appointment_dashboard_section_icon"><span class="fa fa-calendar-plus-o"></span></div>
			...
			<?php if( current_user_can( 'edit_products' ) && apply_filters( 'wcfm_is_allow_manage_products', true ) && apply_filters( 'wcfm_is_allow_add_products', true ) ) { ?>
				<div class="wcfm-container">
					<a href="<?php echo get_wcfm_edit_product_url(); ?>">
						<div id="wcfm_appointments_product_add_expander" class="wcfm-content">
							<div class="appointment_dashboard_section_icon"><span class="fa fa-edit"></span></div>
		...
		<?php if( $wcfm_is_allow_manage_appointment_staff = apply_filters( 'wcfm_is_allow_manage_appointment_staff', true ) ) { ?>
			<div class="wcfm-container-box">
				<div class="wcfm-container wcfm-container-single">
					...
					<?php } ?>
						<div id="wcfm_appointments_staffs_expander" class="wcfm-content">
							<div class="appointment_dashboard_section_icon"><span class="fa fa-group"></span></div>
							<div class="appointment_dashboard_section_label">
								<h2 title="<?php if( !WCFM_Dependencies::wcfmu_plugin_active_check() ) { wcfmu_feature_help_text_show( 'Manage Staffs', false, true ); } ?>"><?php _e( 'Manage Staffs', 'wc-frontend-manager-ultimate' ); ?></h2>
							</div>
						</div>
					<?php if( WCFM_Dependencies::wcfmu_plugin_active_check() ) { ?></a><?php } ?>
				</div>
				...
				<div class="wcfm-container">
					...
					<?php } ?>
						<div id="wcfm_appointments_list_expander" class="wcfm-content">
							<div class="appointment_dashboard_section_icon"><span class="fa fa-calendar"></span></div>
							<div class="appointment_dashboard_section_label">
				...
				<div class="wcfm-container">
					...
					<?php } ?>
						<div id="wcfm_appointments_calendar_expander" class="wcfm-content">
							<div class="appointment_dashboard_section_icon"><span class="fa fa-calendar-o"></span></div>
							<div class="appointment_dashboard_section_label">
