	  ...
	  <div id="wcfm_page_load"></div>
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			if( $allow_wp_admin_view = apply_filters( 'wcfm_allow_wp_admin_view', true ) ) {
				?>
				<a target="_blank" class="wcfm_wp_admin_view text_tip" href="<?php echo admin_url('post-new.php?post_type=appointable_staff'); ?>" data-tip="<?php _e( 'WP Admin View', 'wc-frontend-manager-ultimate' ); ?>"><span class="fa fa-wordpress"></span></a>
				<?php
			}
				...
				<div id="staffs_manage_general_expander" class="wcfm-content">
						<?php
							...
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_staff_manager_fields_availability', array(  
										"_wc_appointment_staff_qty"        => array('label' => __('Capacity', 'woocommerce-appointments') , 'type' => 'number', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title', 'value' => $appointment_staff_qty, 'hints' => __( 'The maximum number of appointments per slot at any given time for any product assigned. Overrides product capacity.', 'woocommerce-appointments' ) ),
