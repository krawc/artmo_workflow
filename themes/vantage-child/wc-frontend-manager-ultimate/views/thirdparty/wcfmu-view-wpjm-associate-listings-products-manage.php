...
<div class="page_collapsible products_manage_wpjm_listings simple variable grouped external booking" id="wcfm_products_manage_form_wpjm_listings_head"><label class="fa fa-list-ul"></label><?php _e('Associate Listings', 'wc-frontend-manager-ultimate'); ?><span></span></div>
