...
<div class="page_collapsible products_manage_redq_rental redq_rental non-variable-subscription" id="wcfm_products_manage_form_redq_rental_head"><label class="fa fa-cab"></label><?php _e('Rental', 'wc-frontend-manager-ultimate'); ?><span></span></div>
<div class="wcfm-container redq_rental non-variable-subscription">
	<div id="wcfm_products_manage_form_redq_rental_expander" class="wcfm-content">
		...
		$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_redq_rental_fields', array( 
			...
			"hourly_price" => array( 'label' => __('Hourly Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')' , 'type' => 'number', 'class' => 'wcfm-text wcfm_ele redq_rental', 'label_class' => 'wcfm_title redq_rental', 'value' => $hourly_price, 'hints' => __( 'Hourly price will be applicabe if booking or rental days min 1day', 'redq-rental' ), 'placeholder' => __( 'Enter price here', 'redq-rental' ) ),
			"general_price" => array( 'label' => __('General Price', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')' , 'type' => 'number', 'class' => 'wcfm-text rentel_pricing rental_general_pricing redq_rental', 'label_class' => 'wcfm_title rentel_pricing rental_general_pricing redq_rental', 'value' => $general_price, 'placeholder' => __( 'Enter price here', 'redq-rental' ) ),
...
<div class="page_collapsible products_manage_redq_rental_discount redq_rental" id="wcfm_products_manage_form_redq_rental_discount_head"><label class="fa fa-moon-o"></label><?php _e('Discount', 'wc-frontend-manager-ultimate'); ?><span></span></div>
	...
	<div id="wcfm_products_manage_form_redq_rental_discount_expander" class="wcfm-content">
		...
		$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
			"redq_price_discount_cost" =>   array('label' => __('Discount depending on day length', 'wc-frontend-manager-ultimate') , 'type' => 'multiinput', 'class' => 'wcfm-text wcfm_ele redq_rental', 'label_class' => 'wcfm_title redq_rental', 'value' => $redq_price_discount_cost, 'options' => array(
										...
										"discount_amount" => array('label' => __('Discount Amount', 'redq-rental') . '(' . get_woocommerce_currency_symbol() . ')', 'type' => 'text', 'class' => 'wcfm-text rental_discount_text redq_rental', 'label_class' => 'wcfm_title rental_discount_label' ),
										)	)
			) );
		?>
	</div>
...
<div class="page_collapsible products_manage_redq_rental_settings redq_rental" id="wcfm_products_manage_form_redq_rental_settings_head"><label class="fa fa-cog"></label><?php _e('Settings', 'wc-frontend-manager-ultimate'); ?><span></span></div>
<div class="wcfm-container redq_rental">
	<div id="wcfm_products_manage_form_redq_rental_settings_expander" class="wcfm-content">
		...
		<?php
		$WCFM->wcfm_fields->wcfm_generate_form_field( array( 
			"redq_rental_fri_min_time" => array( 'label' => __('Friday', 'redq-rental'), 'placeholder' => __('Min Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'label_class' => 'wcfm_title opening_closing_label redq_rental', 'value' => $redq_rental_fri_min_time ),
			"redq_rental_fri_max_time" => array( 'placeholder' => __('Max Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'value' => $redq_rental_fri_max_time ),
			"redq_rental_sat_min_time" => array( 'label' => __('Saturday', 'redq-rental'), 'placeholder' => __('Min Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'label_class' => 'wcfm_title opening_closing_label redq_rental', 'value' => $redq_rental_sat_min_time ),
			"redq_rental_sat_max_time" => array( 'placeholder' => __('Max Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'value' => $redq_rental_sat_max_time ),
			"redq_rental_sun_min_time" => array( 'label' => __('Sunday', 'redq-rental'), 'placeholder' => __('Min Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'label_class' => 'wcfm_title opening_closing_label redq_rental', 'value' => $redq_rental_sun_min_time ),
			"redq_rental_sun_max_time" => array( 'placeholder' => __('Max Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'value' => $redq_rental_sun_max_time ),
			"redq_rental_mon_min_time" => array( 'label' => __('Monday', 'redq-rental'), 'placeholder' => __('Min Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'label_class' => 'wcfm_title opening_closing_label redq_rental', 'value' => $redq_rental_mon_min_time ),
			"redq_rental_mon_max_time" => array( 'placeholder' => __('Max Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'value' => $redq_rental_mon_max_time ),
			"redq_rental_thu_min_time" => array( 'label' => __('Tuesday', 'redq-rental'), 'placeholder' => __('Min Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'label_class' => 'wcfm_title opening_closing_label redq_rental', 'value' => $redq_rental_thu_min_time ),
			"redq_rental_thu_max_time" => array( 'placeholder' => __('Max Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'value' => $redq_rental_thu_max_time ),
			"redq_rental_wed_min_time" => array( 'label' => __('Wednesday', 'redq-rental'), 'placeholder' => __('Min Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'label_class' => 'wcfm_title opening_closing_label redq_rental', 'value' => $redq_rental_wed_min_time ),
			"redq_rental_wed_max_time" => array( 'placeholder' => __('Max Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'value' => $redq_rental_wed_max_time ),
			"redq_rental_thur_min_time" => array( 'label' => __('Thursday', 'redq-rental'), 'placeholder' => __('Min Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'label_class' => 'wcfm_title opening_closing_label redq_rental', 'value' => $redq_rental_thur_min_time ),
			"redq_rental_thur_max_time" => array( 'placeholder' => __('Max Time', 'redq-rental'), 'type' => 'text', 'class' => 'wcfm-text wcfm_ele opening_closing_text redq_rental', 'value' => $redq_rental_thur_max_time ),
			));
		?>
	</div>
</div>