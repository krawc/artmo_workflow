...
<div class="page_collapsible products_manage_mappress simple variable external grouped booking" id="wcfm_products_manage_form_mappress_head"><label class="fa fa-map-marker"></label><?php _e( 'Address', 'wc-frontend-manager-ultimate' ); ?><span></span></div>
	  	  ...
	  	  <div class="wcfm_clearfix"></div>
				<div id='mapp_m_list_panel' style='display:none'>
					...
					<div id='mapp_m_maplist'>
						<?php echo Mappress_Map::get_map_list($product_id); ?>
					</div>
				</div>
