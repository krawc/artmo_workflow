...
<div class="page_collapsible products_manage_wc_box_office_ticket_fields simple variable wc-box-office-ticket" id="wcfm_products_manage_form_wc_box_office_ticket_fields_head"><label class="fa fa-list"></label><?php _e( 'Ticket Fields', 'woocommerce-box-office' ); ?><span></span></div>
...
<div class="page_collapsible products_manage_wc_box_office_ticket_fields simple variable wc-box-office-ticket" id="wcfm_products_manage_form_wc_box_office_ticket_fields_head"><label class="fa fa-print"></label><?php _e( 'Ticket Printing', 'woocommerce-box-office' ); ?><span></span></div>
<div class="wcfm-container simple variable wc-box-office-ticket">
	<div id="wcfm_products_manage_form_wc_box_office_ticket_fields_expander" class="wcfm-content">
		<?php
		...
		<?php
		  $rich_editor = apply_filters( 'wcfm_is_allow_rich_editor', 'rich_editor' );
			$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_wc_box_office_fields_ticket_printing_content', array(  
																										"_ticket_content" => array( 'type' => 'textarea', 'class' => 'wcfm-textarea wcfm_full_ele ' . $rich_editor, 'value' => $_ticket_content ),
																									) ) );
		?>
	</div>
</div>

<div class="page_collapsible products_manage_wc_box_office_ticket_fields simple variable wc-box-office-ticket" id="wcfm_products_manage_form_wc_box_office_ticket_fields_head"><label class="fa fa-envelope-o"></label><?php _e( 'Ticket Emails', 'woocommerce-box-office' ); ?><span></span></div>
<div class="wcfm-container simple variable wc-box-office-ticket">
	<div id="wcfm_products_manage_form_wc_box_office_ticket_fields_expander" class="wcfm-content">
		<?php
		...
		<?php
			$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_wc_box_office_fields_ticket_email_content', array(  
																										"_ticket_email_html" => array( 'type' => 'textarea', 'class' => 'wcfm-textarea wcfm_full_ele ' . $rich_editor, 'value' => $_ticket_email_html ),
																									) ) );
		?>
	</div>
</div>