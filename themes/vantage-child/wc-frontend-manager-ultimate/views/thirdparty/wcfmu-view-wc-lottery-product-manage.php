...
<div class="page_collapsible products_manage_wc_lottery lottery non-variable-subscription" id="wcfm_products_manage_form_lottery_head"><label class="fa fa-dribbble"></label><?php _e('Lottery', 'wc-frontend-manager-ultimate'); ?><span></span></div>
