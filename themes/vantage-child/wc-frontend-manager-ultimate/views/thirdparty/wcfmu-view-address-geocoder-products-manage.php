...
<div class="page_collapsible products_manage_address_geocoder simple variable external grouped booking" id="wcfm_products_manage_form_address_geocoder_head"><label class="fa fa-map-marker"></label><?php echo $address_geocoder_options['meta-box-title']; ?><span></span></div>
<div class="wcfm-container simple variable external grouped booking">
	<div id="wcfm_products_manage_form_address_geocoder_expander" class="wcfm-content">
	  ...
	  <p>
			<a id="geocode" class="button"><?php _e( 'Geocode Address', 'wc-frontend-manager-ultimate' ); ?></a>
	  </p>
	  <div class="wcfm_clearfix"></div><br />
	  <div id="geocodepreview" style="width:300px; height:300px; border:1px solid #DFDFDF"></div>
		<div class="wcfm_clearfix"></div>
	</div>
</div>