...
if( wcfm_is_vendor() && apply_filters( 'wcfm_is_allow_shipping_tracking', true ) ) {
	$needs_shipping_tracking = false; 
	?>
	<div class="wcfm-clearfix"></div>
	<br />
	<!-- collapsible -->
	<div class="page_collapsible orders_details_shipment" id="wcfm_order_shipment_options"><?php _e('Shipemnt Tracking', 'wc-frontend-manager-ultimate'); ?><span></span></div>
