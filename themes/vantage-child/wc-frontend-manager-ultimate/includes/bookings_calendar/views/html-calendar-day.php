	...
	<form method="get" id="mainform" enctype="multipart/form-data" class="wc_bookings_calendar_form">
		...
		<div class="tablenav">
			...
			<div class="date_selector">
				<a class="fa fa-arrow-circle-o-left" href="<?php echo esc_url( add_query_arg( 'calendar_day', date_i18n( 'Y-m-d', strtotime( '-1 day', strtotime( $day ) ) ) ) ); ?>"></a>
				<div>
					<input type="text" name="calendar_day" class="calendar_day wcfm-text" placeholder="yyyy-mm-dd" value="<?php echo esc_attr( $day ); ?>" />
				</div>
				<a class="fa fa-arrow-circle-o-right" href="<?php echo esc_url( add_query_arg( 'calendar_day', date_i18n( 'Y-m-d', strtotime( '+1 day', strtotime( $day ) ) ) ) ); ?>"></a>
			</div>
			<div class="views">
