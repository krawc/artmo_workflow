...
class WCFMu_WCAccommodation_Products_Manage_Controller {
	...
	function wcba_product_manager_data_save( $new_product_id, $wcfm_products_manage_form_data ) {
		...
		$meta_to_save = array(
			...
			'_wc_accommodation_booking_has_restricted_days'        => 'issetyesnoempty'
		);
		...
		$restricted_days = isset( $wcfm_products_manage_form_data['_wc_accommodation_booking_restricted_days'] ) ? wc_clean( $wcfm_products_manage_form_data['_wc_accommodation_booking_restricted_days'] ) : '';
