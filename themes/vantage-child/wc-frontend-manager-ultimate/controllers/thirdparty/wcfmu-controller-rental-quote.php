	...
	public function processing() {
		...
		if(!empty($wcfm_quotes_array)) {
			...
			foreach($wcfm_quotes_array as $wcfm_quotes_single) {
				...
				// Action
				$actions = '';
				$actions .= '<a class="wcfm-action-icon" href="' . get_wcfm_rental_quote_details_url( $wcfm_quotes_single->ID ) . '"><span class="fa fa-eye text_tip" data-tip="' . esc_attr__( 'Details', 'wc-frontend-manager-ultimate' ) . '"></span></a>';
