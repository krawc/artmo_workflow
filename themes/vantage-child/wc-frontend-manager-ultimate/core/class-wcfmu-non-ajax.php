...
class WCFMu_Non_Ajax {
	...
	public function wcfmu_plugin_row_meta( $links, $file ) {
		...
		if ( $WCFMu->plugin_base_name == $file ) {
			$row_meta = array(
				'changelog' => '<a href="' . esc_url( apply_filters( 'wcfmu_changelog_url', 'https://wclovers.com/wcfm-ultimate-changelog/' ) ) . '" aria-label="' . esc_attr__( 'View WCFMu Change Log', 'wc-frontend-manager-ultimate' ) . '">' . esc_html__( 'Change Log', 'wc-frontend-manager-ultimate' ) . '</a>',
				...
				'guide'     => '<a href="' . esc_url( apply_filters( 'wcfm_guide_url', 'https://wclovers.com/documentation/developers-guide/' ) ) . '" aria-label="' . esc_attr__( 'View WCFM Developer Guide', 'wc-frontend-manager' ) . '">' . esc_html__( 'Developer Guide', 'wc-frontend-manager' ) . '</a>',
				...
				'contactus' => '<a href="' . esc_url( apply_filters( 'wcfm_contactus_url', 'https://wclovers.com/contact-us/' ) ) . '" aria-label="' . esc_attr__( 'Any WC help feel free to contact us', 'wc-frontend-manager' ) . '">' . esc_html__( 'Contact US', 'wc-frontend-manager' ) . '</a>'
			);
