...
function reorder_profile_tabs( $tabs ) {
  ...
  $order = array("main", "art_collection", "my_collection", "messages", "friends", "groups_list", "activity", "photos");
  $ordered_tabs = array();
...
?>
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="text" name="wcfm_membership" id="wcfm_membership" value="<?php echo esc_attr( get_the_author_meta( 'wcfm_membership', $user->ID ) ); ?>" class="regular-text" />
            </td>
        </tr>
    </table>
<?php
...
<div class="youtube-videos-container">
  <div class="youtube-videos-player-container">
    <div class="youtube-videos-player-overlay"></div>
...
function artmo_ajax_get_user_videos() {
  ...
  $num_pages = ceil($total_users / $number);

  $user_data_array = $video_ids_array = $video_ids_array_vimeo = array();
  ...
  if ( ! empty( $users ) ) {
      ...
      foreach ( $users as $user ) {
          ...
          $YT_user_fields = array('Video-YouTube', 'Video-YouTube2');
          $VM_user_fields = array('Video-vimeo', 'Video-vimeo2');
          ...
          $user_data['user_display_name'] = $user_display_name;

          foreach($YT_user_fields as $YT_meta_key) {
            ...
            if (isset($value) && !empty($value)) {
              ...
              $user_data_array[$video_id] = $user_data;
              $video_ids_array[] = $video_id;
            }

          }


          foreach($VM_user_fields as $VM_meta_key) {
            ...
            if (isset($value) && !empty($value)) {
              ...
              $user_data_array[$video_id] = $user_data;
              $video_ids_array_vimeo[] = $video_id;
            }
  ...
  $video_ids_str = implode(',', $video_ids_array);
  ...
  foreach ($video_ids_array_vimeo as $video_id) {
  ...
  if (!empty($video_items_vimeo)) {
    foreach ($video_items_vimeo as $item) {
      ...
      $profile_login = $user_data_array[$vm_video_id]['user_login'];
      $profile_display_name = $user_data_array[$vm_video_id]['user_display_name'];
  ...
  if (!empty($video_items)) {
    foreach ($video_items as $item) {
      ...
      $profile_login = $user_data_array[$yt_video_id]['user_login'];
      $profile_display_name = $user_data_array[$yt_video_id]['user_display_name'];
      $profile_link = get_home_url() . '/user/' . $profile_login;
      $result = '';
...
function artmo_home_page_static() {
  ...
  $main_buttons = array(
    "wall" => array(
      "endpoint" => '/wall',
      "image" => 'https://stage.artmo.com/wp-content/uploads/2019/02/1.png',
    ),
    "artists" => array(
      "endpoint" => '/artists',
      "image" => 'https://stage.artmo.com/wp-content/uploads/2019/02/3.jpg',
    ),
    "galleries" => array(
      "endpoint" => '/galleries',
      "image" => 'https://stage.artmo.com/wp-content/uploads/2019/02/2.jpg',
    ),
    "exhibitions" => array(
      "endpoint" => '/exhibitions',
      "image" => 'https://stage.artmo.com/wp-content/uploads/2019/02/4.jpg',
    ),
    "members" => array(
      "endpoint" => '/members',
      "image" => 'https://stage.artmo.com/wp-content/uploads/2019/02/5.jpg',
    ),
    "collections" => array(
      "endpoint" => '/collections',
      "image" => 'https://stage.artmo.com/wp-content/uploads/2019/02/6.jpg',
    ),
    "genres"  => array(
      "endpoint" => '/genres',
      "image" => 'https://stage.artmo.com/wp-content/uploads/2019/02/7.jpg',
    ),
    "universities" => array(
      "endpoint" => '/universities',
      "image" => 'https://stage.artmo.com/wp-content/uploads/2019/02/8.jpg',
    )
  );
