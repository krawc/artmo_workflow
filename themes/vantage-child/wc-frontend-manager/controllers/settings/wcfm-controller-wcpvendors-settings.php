...
class WCFM_Settings_WCPVendors_Controller {
	...
	public function processing() {
	  ...
	  // sanitize
		...
		if(isset($wcfm_settings_form['shipping_policy']) && !empty($wcfm_settings_form['shipping_policy'])) {
			update_user_meta($user_id, 'shipping_policy', $wcfm_settings_form['shipping_policy']);
		}
