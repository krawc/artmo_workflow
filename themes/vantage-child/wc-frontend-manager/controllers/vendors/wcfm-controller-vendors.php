	...
	public function processing() {
		...
		if(!empty($wcfm_vendors_array)) {
			...
			foreach($wcfm_vendors_array as $wcfm_vendors_id => $wcfm_vendors_name ) {
				...
				// Name
				$wcfm_vendors_json_arr[$index][] =  '<a href="'. get_wcfm_vendors_manage_url($wcfm_vendors_id) . '" class="wcfm_dashboard_item_title">' . apply_filters( 'wcfm_vednors_display_name_data', $wcfm_vendors_name, $wcfm_vendors_id ) . '</a>';
				...
				// Additional Info
				$wcfm_vendors_json_arr[$index][] = apply_filters( 'wcfm_vendors_additonal_data', '&ndash;' );
