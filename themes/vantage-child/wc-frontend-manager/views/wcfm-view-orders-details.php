  ...
  <div class="wcfm-page-headig">
	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			<span class="order-status order-status-<?php echo sanitize_title( $theorder->get_status() ); ?>"><?php _e( ucfirst( sanitize_title( $theorder->get_status() ) ), 'wc-frontend-manager' ); ?></span>
			...
			<div id="order_quick_actions">
				...
				add_action( 'wcfm_after_order_quick_actions', $order_id );
				?>
			</div>
		</div>
	  ...
	  <?php do_action( 'begin_wcfm_orders_details' ); ?>
		...
		<div class="wcfm-container wcfm-container-general">
		    ...
		    <?php if( $wcfm_is_allow_order_details = apply_filters( 'wcfm_allow_order_details', true ) ) { ?>
					<p class="form-field form-field-wide wc-customer-user">
						<label for="customer_user"><?php _e( 'Customer:', 'wc-frontend-manager' ) ?></label>
						<?php
						$user_string = '';
						$user_id     = '';
		...
		<!-- collapsible -->
		<div class="wcfm-container wcfm-container-items">
			<div id="orders_details_items_expander" class="wcfm-content woocommerce-order-details">
				<section cellpadding="0" cellspacing="0" class="woocommerce_order_items">
					<ul class="order-products" id="order_line_items">
					<?php
						...
						foreach ( $line_items as $item_id => $item ) {
							...
							?>
							<li class="product cart_item item <?php echo apply_filters( 'woocommerce_admin_html_order_item_class', ( ! empty( $class ) ? $class : '' ), $item, $order ); ?>" data-order_item_id="<?php echo $item_id; ?>">
								...
								<div class="product-data" data-sort-value="<?php echo esc_attr( $item->get_name() ); ?>">
									<?php
