...
class WCFM_Library {
  ...
  public $views_path;
    ...
    $wcfm_dashboard_messages = get_wcfm_dashboard_messages();
	  ...
	  do_action( 'before_wcfm_load_scripts', $end_point );
		...
		wp_enqueue_script( 'jquery-ui', $scheme . '://code.jquery.com/ui/1.12.1/jquery-ui.js' );
  ...
  //  * Jquery Accordian library
  //  */
  // public function load_tagthis_lib() {
  //   global $WCFM;
  //   wp_enqueue_script( 'tagthis_js', $this->js_lib_url . 'jquery.tagthis.js', array('jquery'), true );
  // }
