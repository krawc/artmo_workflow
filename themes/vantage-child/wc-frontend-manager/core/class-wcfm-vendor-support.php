  	...
  	global $WCFM;
		...
		if( apply_filters( 'wcfm_is_allow_product_review_email', false ) ) {
			...
			$review_mail_body    = __( 'Hi', 'wc-frontend-manager' ) .
															 ',<br/><br/>' .
															 sprintf( __( 'Product awaiting <b>%s</b> for review', 'wc-frontend-manager' ), '<a class="wcfm_dashboard_item_title" href="' . get_wcfm_edit_product_url( $new_product_id ) . '">' . get_the_title( $new_product_id ) . '</a>' ) .
