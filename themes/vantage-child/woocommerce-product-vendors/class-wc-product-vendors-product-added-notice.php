...
class WC_Product_Vendors_Product_Approved_Notice extends WC_Email {
	/**
	 * Constructor
	 *
	 * @access public
	...
	public function __construct() {
		$this->id               = 'product_approved_notice';
		$this->title            = __( 'Product Approved Notice', 'woocommerce-product-vendors' );
		$this->description      = __( 'When a admin approved a product, this notice will be sent to the vendor.', 'woocommerce-product-vendors' );
		$this->heading          = __( 'Artwork Approved Notice', 'woocommerce-product-vendors' );
		$this->subject          = __( '[{site_title}] Artwork Approved', 'woocommerce-product-vendors' );
		$this->template_base    = get_stylesheet_directory_uri();
		$this->template_html    = 'emails/product-approved-notice.php';
		$this->template_plain   = 'emails/plain/product-approved-notice.php';
...
return new WC_Product_Vendors_Product_Approved_Notice();
